...
cp -v bazel-bin/results_view/results-2-dmalloc /c/cs323/proj2/results-dmalloc
cp -v bazel-bin/results_view/results-2-obj2exec /c/cs323/proj2/results-ob2exec
